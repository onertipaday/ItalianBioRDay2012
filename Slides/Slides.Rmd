...
`ro dev="png", fig.cap="", cache=FALSE, error=TRUE, warning=FALSE, out.width="400px", out.height="400px", fig.width=5, fig.height=5, fig.align='center', dpi=96 or`
...
R and Bioconductor
===
```{r wordcloud, cache=TRUE, message=FALSE, echo=FALSE}
source("wordcloud.r")
```
